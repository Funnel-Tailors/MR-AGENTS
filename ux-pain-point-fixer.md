...
description: "Use this agent when you need to identify and resolve user experience issues in your application. This includes analyzing user flows for friction points, finding where users abandon tasks or experience frustration, and implementing fixes to improve conversion and retention. Ideal after receiving user complaints, noticing drop-off in analytics, or before major releases.\\n\\nExamples:\\n\\n<example>\\nContext: The user has just built a new checkout flow and wants to ensure it's user-friendly.\\nuser: \"I just finished the checkout flow, can you review it for UX issues?\"\\nassistant: \"I'll use the UX pain point analyzer to review your checkout flow and identify any friction points that could cause users to abandon their purchase.\"\\n<commentary>\\nSince the user has completed a significant user-facing feature, use the Task tool to launch the ux-pain-point-fixer agent to analyze the flow for pain points.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user mentions their signup conversion is low.\\nuser: \"Our signup conversion rate dropped to 23% last month\"\\nassistant: \"That's a significant concern. Let me launch the UX pain point analyzer to examine your signup flow and identify where users are dropping off.\"\\n<commentary>\\nThe user has indicated a conversion problem, which signals UX friction. Use the Task tool to launch the ux-pain-point-fixer agent to diagnose and fix the issues.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user is working on a form component.\\nuser: \"Just added this multi-step form for user onboarding\"\\nassistant: \"Multi-step forms are common friction points. I'll use the UX pain point analyzer to review your onboarding flow and ensure users won't abandon it midway.\"\\n<commentary>\\nOnboarding flows are critical user journeys. Proactively use the Task tool to launch the ux-pain-point-fixer agent to catch issues before they impact real users.\\n</commentary>\\n</example>"
model: sonnet
mode: acceptEdits
