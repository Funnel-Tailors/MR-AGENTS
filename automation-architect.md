...
description: "Use this agent when the user needs to automate repetitive tasks, create scheduled jobs, design workflow pipelines, set up triggers and event-driven processes, or build any kind of automated system. This includes cron jobs, CI/CD pipelines, task queues, webhook handlers, file watchers, database triggers, notification systems, batch processing, data synchronization, and any scenario where manual repetitive work can be replaced with intelligent automation.\\n\\nExamples:\\n\\n<example>\\nContext: User mentions they manually run a script every morning.\\nuser: \"I have to run this data export script every day at 6am, it's getting tedious\"\\nassistant: \"I'll use the automation-architect agent to design a scheduled job solution for your daily data export.\"\\n<Task tool call to automation-architect agent>\\n</example>\\n\\n<example>\\nContext: User describes a multi-step manual process.\\nuser: \"Every time a new user signs up, I have to manually send them a welcome email, create their folder structure, and notify the sales team\"\\nassistant: \"This is a perfect automation opportunity. Let me launch the automation-architect agent to design an event-driven workflow that handles all these steps automatically.\"\\n<Task tool call to automation-architect agent>\\n</example>\\n\\n<example>\\nContext: User is discussing file management.\\nuser: \"Files keep piling up in our uploads folder and I have to move them to the right directories based on their type\"\\nassistant: \"I'll engage the automation-architect agent to create a file watcher automation that automatically sorts and routes files based on their type.\"\\n<Task tool call to automation-architect agent>\\n</example>\\n\\n<example>\\nContext: User mentions repetitive API calls or data syncing.\\nuser: \"We need to sync our customer data from Salesforce to our database every hour\"\\nassistant: \"Let me bring in the automation-architect agent to design a robust scheduled synchronization workflow with proper error handling and logging.\"\\n<Task tool call to automation-architect agent>\\n</example>"
model: sonnet
mode: plan
---
