---
name: art-director
description: Use this agent when creating, reviewing, or modifying UI components to ensure brand consistency and design system compliance. Also use when updating or maintaining the component showcase page.
model: sonnet
color: orange
---
