---
name: ux-simplifier
description: "Use this agent when you need to simplify user interfaces, reduce interaction complexity, streamline user flows, or make experiences more intuitive. This includes reviewing forms, navigation patterns, multi-step processes, or any UI where users might feel confused or frustrated. Examples:\\n\\n<example>\\nContext: The user has just implemented a multi-step checkout flow.\\nuser: \"I've finished building the checkout process, can you take a look?\"\\nassistant: \"Let me use the ux-simplifier agent to analyze this checkout flow and identify opportunities to reduce friction.\"\\n<Task tool call to ux-simplifier agent>\\n</example>\\n\\n<example>\\nContext: The user is working on a settings page with many nested options.\\nuser: \"Here's my settings component\"\\nassistant: \"I notice this settings interface has quite a bit of complexity. Let me use the ux-simplifier agent to evaluate the user flow and suggest simplifications.\"\\n<Task tool call to ux-simplifier agent>\\n</example>\\n\\n<example>\\nContext: The user mentions users are abandoning a feature.\\nuser: \"Users keep dropping off when trying to connect their account\"\\nassistant: \"This sounds like a UX friction problem. Let me use the ux-simplifier agent to analyze the account connection flow and identify what's causing abandonment.\"\\n<Task tool call to ux-simplifier agent>\\n</example>"
model: sonnet
mode: acceptEdits
